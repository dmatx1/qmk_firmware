...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           KC_SPC,           KC_SPC,                    KC_RALT, KC_LEFT, KC_DOWN, MT_RCTL
     ),
    [1] = LAYOUT_all(
        ...
        _______, _______, _______,          KC_ESC,           KC_ESC,           KC_ESC,                    _______, KC_LEFT, KC_DOWN, KC_RGHT
     ),
    [2] = LAYOUT_all(
        ...
        _______, _______, _______,          KC_ESC,           KC_ESC,           KC_ESC,                    _______, _______, _______, _______
     ),
    [3] = LAYOUT_all(
        ...
        _______, SL_NUBS, _______, KC_KLEX, KC_KLCP, KL_PACL, KL_PAST, _______, _______, SL_COMM, SL_DOT,  SL_SLSH,          _______, _______,
    ...
    [4] = LAYOUT_all(
        ...
        _______, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, KC_KP_4, KC_KP_5, KC_KP_6, _______, _______, EEP_RST,          RESET,
