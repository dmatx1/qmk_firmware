...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                                                                 MT_RALT, KC_DOWN, MT_RCTL
     ),
    [1] = LAYOUT_all(
        ...
        _______, _______, _______,          KC_ESC,                                                                 KC_LEFT, KC_DOWN, KC_RGHT
     ),
    [2] = LAYOUT_all(
    ...
    [4] = LAYOUT_all(
        _______, _______, _______, _______, _______, _______, KC_NLCK, KC_KP_7, KC_KP_8, KC_KP_9, _______, _______, _______, _______, _______,
