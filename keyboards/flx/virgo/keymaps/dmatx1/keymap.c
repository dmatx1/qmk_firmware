...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
        ...
        _______, SL_NUBS, _______, KC_KPEX, KC_KPCP, KP_PACL, KP_PAST,          _______, _______, _______, SL_COMM, SL_DOT,  SL_SLSH,          _______, _______,            _______,
        _______,          _______, _______,          _______,                            _______,          _______, _______,          _______,                     _______, _______, _______
    ),
    [4] = LAYOUT(
        _______,          _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
        _______, _______, _______, _______, _______, _______, KC_NLCK,                   KC_KP_7, KC_KP_8, KC_KP_9, _______, _______, _______, _______, _______,   _______, _______, _______,
        ...
        _______, _______, KC_PGUP, KC_PGDN, _______, _______, _______,          _______, _______, KC_KP_0, KC_PDOT, _______, _______,          _______, _______,            _______,
        _______,          _______, _______,          _______,                            _______,          _______, _______,          _______,                     _______, _______, _______
    ),
